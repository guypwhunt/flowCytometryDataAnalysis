...
setwd(paste0("./data/isotypes/", directoryName, "/transformedData"))
...
p <- ggcyto(dfs_fs, aes_string("FPRL1...AF647.A", "GPR32...AF488.A")) +
  geom_hex(bins = 128) + xlim(-8, 8) + ylim(-12, 12)
q <- ggcyto(isodfs_fs, aes_string("FPRL1...AF647.A", "GPR32...AF488.A")) +
  geom_hex(bins = 128) + xlim(c(-8, 8)) + ylim(c(-12, 12))
p
q
