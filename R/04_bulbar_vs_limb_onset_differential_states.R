...
allSenescenceDS <-
  read.csv(
    "data/senescence/differentialTestingOutputs/bulbarVsLimbOnsetVisitOneOneClusterDifferentialStatesStatistics.csv"
  )
...
senescenceClustersDS <-
  read.csv(
    "data/senescence/differentialTestingOutputs/bulbarVsLimbOnsetOneDifferentialStatesStatistics.csv"
  )
