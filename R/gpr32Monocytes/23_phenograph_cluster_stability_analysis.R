...
clusterNames <- c("clusters_phenograph", "clusters_phenographMarker")
...
results <- read.csv(paste0("./data/", directoryName, '/clusteringOutput/', 'clusters_phenograph_Stability.csv'))
