...
markerName <- c("GPR18", "GPR32")

fileName <- paste0(paste(markerName, collapse = ""),
                   clusterName,
...
coxModelForumla <-
  ...
  riluzole + delataAlsfrsRScore + GPR18_median_Positive_Follicular_B_Cells +
  GPR18_median_Positive_Unswitched_Memory_B_Cells_.CD24_Negative_. +
