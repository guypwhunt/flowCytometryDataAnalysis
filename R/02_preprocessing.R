...
gc()
dfs_fs_t_manual_normfda <- warpSet(dfs_fs_t_auto, stains=c('FSC.A','SSC.A','GPR32...AF488.A','FoxP3.PE.A','CD19...PE.CF595.A','IgD...PerCP.Cy5.5.A', 'FPRL1...AF647.A', 'Zombie.NIR.A', 'IL.17...BV421.A', 'CD24...BV605.A', 'CD27...BV650.A'))
gc()
save.image()
gc()
...
densityplot(~FSC.A+SSC.A, dfs_fs_t_manual_normfda, main="auto")
dev.off()
gc()
jpeg(file = paste0(figureDirectory,"normaliseddensityplot2.jpeg"))
densityplot(~GPR32...AF488.A+FoxP3.PE.A, dfs_fs_t_manual_normfda, main="auto")
dev.off()
gc()
jpeg(file = paste0(figureDirectory,"normaliseddensityplot3.jpeg"))
densityplot(~CD19...PE.CF595.A+IgD...PerCP.Cy5.5.A, dfs_fs_t_manual_normfda, main="auto")
dev.off()
gc()
jpeg(file = paste0(figureDirectory,"normaliseddensityplot4.jpeg"))
densityplot(~IFNg.PE.Cy7.A+FPRL1...AF647.A, dfs_fs_t_manual_normfda, main="auto")
dev.off()
gc()
jpeg(file = paste0(figureDirectory,"normaliseddensityplot5.jpeg"))
densityplot(~Zombie.NIR.A+IL.17...BV421.A, dfs_fs_t_manual_normfda, main="auto")
dev.off()
gc()
jpeg(file = paste0(figureDirectory,"normaliseddensityplot6.jpeg"))
densityplot(~CD24...BV605.A+CD27...BV650.A, dfs_fs_t_manual_normfda, main="auto")
dev.off()
gc()
##############################
####### EXPORT TO FCS ########
...
write.flowSet(dfs_fs_t_manual_normfda, outdir='dataPPOutput', filename = paste0(gsub(".csv", ".fcs", sampleNames(dfs_fs_t_manual_normfda))))
gc()
