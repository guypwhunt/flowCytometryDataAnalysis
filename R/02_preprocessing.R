...
densityplot(~FSC.A, dfs_fs_t_auto, main="auto")
dev.off()
gc()
jpeg(file = paste0(figureDirectory,"densityPlotSSCA.jpeg"))
densityplot(~SSC.A, dfs_fs_t_auto, main="auto")
dev.off()
gc()
...
densityplot(~FoxP3.PE.A, dfs_fs_t_auto, main="auto")
dev.off()
gc()
jpeg(file = paste0(figureDirectory,"densityPlotCD19PECF595A.jpeg"))
densityplot(~CD19...PE.CF595.A, dfs_fs_t_auto, main="auto")
dev.off()
gc()
jpeg(file = paste0(figureDirectory,"densityPlotIgDPerCPCy55A.jpeg"))
densityplot(~IgD...PerCP.Cy5.5.A, dfs_fs_t_auto, main="auto")
dev.off()
gc()
jpeg(file = paste0(figureDirectory,"densityPlotIFNgPECy7A.jpeg"))
densityplot(~IFNg.PE.Cy7.A, dfs_fs_t_auto, main="auto")
dev.off()
gc()
...
densityplot(~IL.17...BV421.A, dfs_fs_t_auto, main="auto")
dev.off()
gc()
...
densityplot(~CD24...BV605.A, dfs_fs_t_auto, main="auto")
dev.off()
gc()
jpeg(file = paste0(figureDirectory,"densityPlotCD27BV650.jpeg"))
densityplot(~CD27...BV650.A, dfs_fs_t_auto, main="auto")
dev.off()
gc()
...
densityplot(~FSC.A, dfs_fs_t_auto_normfda, main="auto")
dev.off()
gc()
jpeg(file = paste0(figureDirectory,"normalisedDensityPlotSSCA.jpeg"))
densityplot(~SSC.A, dfs_fs_t_auto_normfda, main="auto")
dev.off()
gc()
...
densityplot(~FoxP3.PE.A, dfs_fs_t_auto_normfda, main="auto")
dev.off()
gc()
jpeg(file = paste0(figureDirectory,"normalisedDensityPlotCD19PECF595A.jpeg"))
densityplot(~CD19...PE.CF595.A, dfs_fs_t_auto_normfda, main="auto")
dev.off()
gc()
jpeg(file = paste0(figureDirectory,"normalisedDensityPlotIgDPerCPCy55A.jpeg"))
densityplot(~IgD...PerCP.Cy5.5.A, dfs_fs_t_auto_normfda, main="auto")
dev.off()
gc()
jpeg(file = paste0(figureDirectory,"normalisedDensityPlotIFNgPECy7A.jpeg"))
densityplot(~IFNg.PE.Cy7.A, dfs_fs_t_auto_normfda, main="auto")
dev.off()
gc()
...
densityplot(~IL.17...BV421.A, dfs_fs_t_auto_normfda, main="auto")
dev.off()
gc()
...
densityplot(~CD24...BV605.A, dfs_fs_t_auto_normfda, main="auto")
dev.off()
gc()
jpeg(file = paste0(figureDirectory,"normalisedDensityPlotCD27BV650.jpeg"))
densityplot(~CD27...BV650.A, dfs_fs_t_auto_normfda, main="auto")
dev.off()
gc()
