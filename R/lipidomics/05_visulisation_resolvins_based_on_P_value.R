...
combinedDf <- combinedDf[combinedDf$experiment != "ProgressionAndSightOfOnsetgroupFastLimbLateVsgroupFastBulbarLate.csv",]
combinedDf <- combinedDf[combinedDf$experiment != "BulbarVsLimbBulbarEarlyVsLimbLate.csv",]
combinedDf <- combinedDf[combinedDf$experiment != "BulbarVsLimbLimbEarlyVsBulbarEarly.csv",]
