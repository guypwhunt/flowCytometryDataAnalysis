...
allBCellsDS <-
  read.csv(
    "data/bCells/differentialTestingOutputs/caseVsControlVisitOneOneClusterDifferentialAbundanceStatistics.csv"
  )
allBCellsDS[, "panel"] <-
  "bCells"
...
bCellsClustersDS <-
  read.csv(
    "data/bCells/differentialTestingOutputs/caseVsControlVisitOneDifferentialAbundanceStatistics.csv"
  )
...
allMonocytesDS <-
  read.csv(
    "data/monocytes/differentialTestingOutputs/caseVsControlVisitOneOneClusterDifferentialAbundanceStatistics.csv"
  )
...
monocytesClustersDS <-
  read.csv(
    "data/monocytes/differentialTestingOutputs/caseVsControlVisitOneDifferentialAbundanceStatistics.csv"
  )
...
allTCellsDS <-
  read.csv(
    "data/tCells/differentialTestingOutputs/caseVsControlVisitOneOneClusterDifferentialAbundanceStatistics.csv"
  )
allTCellsDS[, "panel"] <-
  "tCells"
...
tCellsClustersDS <-
  read.csv(
    "data/tCells/differentialTestingOutputs/caseVsControlVisitOneDifferentialAbundanceStatistics.csv"
  )
...
allSenescenceDS <-
  read.csv(
    "data/senescence/differentialTestingOutputs/caseVsControlVisitOneOneClusterDifferentialAbundanceStatistics.csv"
  )
...
senescenceClustersDS <-
  read.csv(
    "data/senescence/differentialTestingOutputs/caseVsControlVisitOneDifferentialAbundanceStatistics.csv"
  )
...
df[df[,"fdr_adjusted_p_val"] < 0.05 & !is.na(df[,"fdr_adjusted_p_val"]),
   c("typeOfCells", "panel","cluster_id", "logFC","fdr_adjusted_p_val")]
