...
ggcyto(dfs_outliers_fs[1], aes_string("CD11b...17BV421.A", "CD11b.activated...PE.Cy7.A")) +
  geom_hex(bins = 128)

ggcyto(dfs_outliers_fs[2], aes_string("CD11b...17BV421.A", "CD11b.activated...PE.Cy7.A")) +
  geom_hex(bins = 128)
