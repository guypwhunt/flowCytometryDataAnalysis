...
allBCellsDS <-
  read.csv(
    "data/bCells/differentialTestingOutputs/fastVsSlowVisitOneOneClusterDifferentialStatesStatistics.csv"
  )
allBCellsDS[, "panel"] <-
  "bCells"
...
bCellsClustersDS <-
  read.csv(
    "data/bCells/differentialTestingOutputs/fastVsSlowVisitOneDifferentialStatesStatistics.csv"
  )
...
allMonocytesDS <-
  read.csv(
    "data/monocytes/differentialTestingOutputs/fastVsSlowVisitOneOneClusterDifferentialStatesStatistics.csv"
  )
...
monocytesClustersDS <-
  read.csv(
    "data/monocytes/differentialTestingOutputs/fastVsSlowVisitOneDifferentialStatesStatistics.csv"
  )
...
allTCellsDS <-
  read.csv(
    "data/tCells/differentialTestingOutputs/fastVsSlowVisitOneOneClusterDifferentialStatesStatistics.csv"
  )
allTCellsDS[, "panel"] <-
  "tCells"
...
tCellsClustersDS <-
  read.csv(
    "data/tCells/differentialTestingOutputs/fastVsSlowVisitOneDifferentialStatesStatistics.csv"
  )
...
allSenescenceDS <-
  read.csv(
    "data/senescence/differentialTestingOutputs/fastVsSlowVisitOneOneClusterDifferentialStatesStatistics.csv"
  )
...
senescenceClustersDS <-
  read.csv(
    "data/senescence/differentialTestingOutputs/fastVsSlowVisitOneDifferentialStatesStatistics.csv"
  )
