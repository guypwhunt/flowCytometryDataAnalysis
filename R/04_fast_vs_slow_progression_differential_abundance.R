...
allBCellsDS <-
  read.csv(
    "data/bCells/differentialTestingOutputs/fastVsSlowVisitOneOneClusterDifferentialAbundanceStatistics.csv"
  )
allBCellsDS[, "panel"] <-
  "bCells"
...
bCellsClustersDS <-
  read.csv(
    "data/bCells/differentialTestingOutputs/fastVsSlowVisitOneDifferentialAbundanceStatistics.csv"
  )
...
allMonocytesDS <-
  read.csv(
    "data/monocytes/differentialTestingOutputs/fastVsSlowVisitOneOneClusterDifferentialAbundanceStatistics.csv"
  )
...
monocytesClustersDS <-
  read.csv(
    "data/monocytes/differentialTestingOutputs/fastVsSlowVisitOneDifferentialAbundanceStatistics.csv"
  )
...
allTCellsDS <-
  read.csv(
    "data/tCells/differentialTestingOutputs/fastVsSlowVisitOneOneClusterDifferentialAbundanceStatistics.csv"
  )
allTCellsDS[, "panel"] <-
  "tCells"
...
tCellsClustersDS <-
  read.csv(
    "data/tCells/differentialTestingOutputs/fastVsSlowVisitOneDifferentialAbundanceStatistics.csv"
  )
...
allSenescenceDS <-
  read.csv(
    "data/senescence/differentialTestingOutputs/fastVsSlowVisitOneOneClusterDifferentialAbundanceStatistics.csv"
  )
...
senescenceClustersDS <-
  read.csv(
    "data/senescence/differentialTestingOutputs/fastVsSlowVisitOneDifferentialAbundanceStatistics.csv"
  )
